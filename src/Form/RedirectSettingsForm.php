...
class RedirectSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['redirect_passthrough_querystring'] = array(
      ...
      '#default_value' => $redirect_settings['passthrough_querystring'],
    ...
    $form['redirect_warning'] = array(
      ...
      '#default_value' => $redirect_settings['warning'],
      '#access' => FALSE,
    );
    $form['redirect_default_status_code'] = array(
      ...
      '#default_value' => $redirect_settings['default_status_code'],
    );
    ...
    $form['redirect_purge_inactive'] = array(
      ...
      '#default_value' => $redirect_settings['purge_inactive'],
      ...
      '#disabled' => $redirect_settings['page_cache'] && !$invoke_hooks,
    );
